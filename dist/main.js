    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                spreadService = new spread_service_1.SpreadService(configService, requestService, platformService, userService, botService);
                poolService = new pool_service_1.PoolService(configService, requestService, userService, botService);
